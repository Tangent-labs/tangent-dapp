...
export function IconCopyPaste({ className }: IconProps) {
  return (
    <svg width="13" height="15" className={className || ""} viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
