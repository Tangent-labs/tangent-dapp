...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn("group/navigation-menu relative hidden max-w-max md-lg:flex", className)}
      {...props}
    >
      {children}
    ...
    <div className={cn("absolute left-0 top-full isolate z-50 flex justify-center")}>
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "border-white border-opacity-10 bg-overlay-panel shadow backdrop-blur-[60px]",
