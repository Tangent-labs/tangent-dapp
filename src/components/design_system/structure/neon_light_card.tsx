...
export function NeonLightCard(props: { px: string; color1: string; color2: string; className: string; children: ReactNode }) {
  return (
    <div className={`flex overflow-hidden rounded-lg ${props.className}`}>
      <div
        className={`shadow-2x relative w-full rounded-lg py-2.5 ${props.px}`}
        style={{
          background: `
