...
export function IconSingleArrow({ className }: IconProps) {
  return (
    <svg width="10" height="8" className={className || ""} viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
