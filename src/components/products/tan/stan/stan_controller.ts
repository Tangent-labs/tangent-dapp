...
import { StakingInfo } from "../tan_type"
import { TAN_CONTRACT } from "../tan_repository"

export async function getTanStakeOnChainData(currentAddress: Address | undefined) {
  return await executeChainViewUnique<StakingInfo>(stakeUI.abi as Abi, stakeUI.bytecode as Hex, [currentAddress, TAN_CONTRACT.TAN, TAN_CONTRACT.STAN])
}
