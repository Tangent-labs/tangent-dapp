...
export function MenuSide() {
  const { currentProduct, currentFeature } = useNavigationContext()
  return (
    <Panel className="min-h-[98dvh] !p-0 w-full">
      ...
      <div className="px-2 mt-6 flex flex-col gap-4">
        {[productsData.wrapper, productsData.splitter, productsData.booster].map((productData) => (
          <MenuSideProduct
            ...
            isCurrentProduct={productData.key === currentProduct}
            currentFeature={currentFeature}
          />
        ))}
        {/* Product TGUSD  ---------------------------------------- */}
        <div>
          <div className="flex gap-5 items-center ml-4 text-gray-700">
