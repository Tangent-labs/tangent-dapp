...
const ListRowSkeleton = () => {
  return (
    <Panel
      className={`relative mb-2 border-2 p-5 before:absolute before:inset-0 before:-z-10 before:rounded-[10px] before:opacity-70 hover:cursor-pointer hover:before:bg-list-row-hover`}
    >
      <ListRowDisposition>
