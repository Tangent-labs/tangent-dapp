      ...
      <div className="flex w-full items-start justify-between gap-4">
        <div className="sgusd-card w-7/12">
          ...
          <div className="flex flex-col items-start justify-center gap-3">
            ...
            <p>
              Borrow USG, provide liquidity, and vote for USG and sgUSD pools to earn points. Points will be convertible for TAN tokens once the campaign ends.
            </p>
          </div>
        </div>

        <div className="flex w-5/12 flex-col items-stretch justify-between gap-6">
